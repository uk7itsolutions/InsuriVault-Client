    ...
    'environment' => [
        'form' => [
            'rules' => [
                ...
                'insurivault_api_url'      => 'required|url',
                'insurivault_organization' => 'required|string|max:100',
                'insurivault_origin_host'   => 'nullable|string|max:100',
                'insurivault_verify_ssl'    => 'required|string',
            ],
        ],
    ],
