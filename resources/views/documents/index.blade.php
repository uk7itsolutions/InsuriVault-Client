                            ...
                            <tr class="border-t-[1px] border-[var(--portal-border)] transition hover:bg-[var(--portal-surface-subtle)]">
                                ...
                                <td class="px-4 py-3 text-right whitespace-nowrap">
                                    <a href="{{ route('documents.show', [$accountEntry['account']['id'], $file['fileId']]) }}"
                                       class="inline-flex items-center gap-1 rounded-md border-[1px] border-[var(--portal-accent-on-surface)] px-2 py-1 text-xs font-medium text-[var(--portal-accent-on-surface)] no-underline transition hover:bg-[var(--portal-accent)] hover:text-[var(--portal-accent-contrast)]"
                                       title="View">
