            ...
            <div class="tab" id="tab3content">
                ...
                <div class="block margin-bottom-2">
                    ...
                    <label for="appSettingsTab5">
                        <span>
                            {{ trans('installer_messages.environment.wizard.form.app_tabs.insurivault_label') }}
                        </span>
                    </label>
                    <div class="info">
                        <div class="form-group {{ $errors->has('insurivault_api_url') ? ' has-error ' : '' }}">
                            <label for="insurivault_api_url">
                                {{ trans('installer_messages.environment.wizard.form.app_tabs.insurivault_api_url_label') }}
                            </label>
                            <input type="text" name="insurivault_api_url" id="insurivault_api_url" value="https://client-api.insuri-vault.com" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.insurivault_api_url_placeholder') }}" />
                            @if ($errors->has('insurivault_api_url'))
                                <span class="error-block">
                                    <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                                    {{ $errors->first('insurivault_api_url') }}
                                </span>
                            @endif
                        </div>
                        <div class="form-group {{ $errors->has('insurivault_organization') ? ' has-error ' : '' }}">
                            <label for="insurivault_organization">
                                {{ trans('installer_messages.environment.wizard.form.app_tabs.insurivault_organization_label') }}
                            </label>
                            <input type="text" name="insurivault_organization" id="insurivault_organization" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.insurivault_organization_placeholder') }}" />
                            @if ($errors->has('insurivault_organization'))
                                <span class="error-block">
                                    <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                                    {{ $errors->first('insurivault_organization') }}
                                </span>
                            @endif
                        </div>
                        <div class="form-group {{ $errors->has('insurivault_origin_host') ? ' has-error ' : '' }}">
                            <label for="insurivault_origin_host">
                                {{ trans('installer_messages.environment.wizard.form.app_tabs.insurivault_origin_host_label') }}
                            </label>
                            <input type="text" name="insurivault_origin_host" id="insurivault_origin_host" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.insurivault_origin_host_placeholder') }}" />
                            @if ($errors->has('insurivault_origin_host'))
                                <span class="error-block">
                                    <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                                    {{ $errors->first('insurivault_origin_host') }}
                                </span>
                            @endif
                        </div>
                        <div class="form-group {{ $errors->has('insurivault_verify_ssl') ? ' has-error ' : '' }}">
                            ...
                            <select name="insurivault_verify_ssl" id="insurivault_verify_ssl">
                                <option value="true" selected>True</option>
                                <option value="false">False</option>
                            </select>
                            @if ($errors->has('insurivault_verify_ssl'))
                                <span class="error-block">
                                    <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                                    {{ $errors->first('insurivault_verify_ssl') }}
                                </span>
                            @endif
                        </div>
                    </div>
